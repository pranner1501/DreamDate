	...
	try {
		...
		const users = await User.find({
			$and: [
				...
				{ _id: { $nin: currentUser.likes } }, // Exclude liked users
				{ _id: { $nin: currentUser.dislikes } }, // Exclude disliked users
				...
				{ genderPreference: { $in: [currentUser.gender, "both"] } }, // Match their preference
